...
public class ThesisLoggingHandler implements ILoggingHandler
{
    ...
    public ThesisLoggingHandler(FileChannel channel, IVmsSerdesProxy serdesProxy, int bufferSize)
    {
