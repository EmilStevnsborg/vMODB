...
//            InboundEvent event_ = new InboundEvent(1,0,1,res.outputQueue(),clazz,res.output(), 0);
...
//
//        TransactionEvent.PayloadRaw eventInput = TransactionEvent.of(1,1,"in", inputPayload, serdes.serializeMap(precedenceMap), 0);
...
//        precedenceMap.put("example1", 0L);
//
//        TransactionEvent.PayloadRaw eventInput = TransactionEvent.of(1,0,"in", inputPayload, serdes.serializeMap(precedenceMap), 0);
//        TransactionEvent.writeWithinBatch(buffer, eventInput);
//        buffer.flip();
//        channel.write(buffer).get(); // no need to wait
//
