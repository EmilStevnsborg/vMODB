...
import dk.ku.di.dms.vms.tpcc.benchmark.ingestion.IngestionWorkerCustomer;
import dk.ku.di.dms.vms.tpcc.benchmark.ingestion.IngestionWorkerStock;
import dk.ku.di.dms.vms.tpcc.benchmark.ingestion.IngestionWorkerWarehouse;
...
public class AbortExperiment
{
    ...
    public AbortExperiment(int numTransactions)
    {
        ...
        this.newOrderWareInInput = Workload.createNewOrderIterator(numTransactions);
    }
    ...
    public ExperimentResults runExperiment(int runTime, int warmup)
    {
        ...
        var orderFlightsThread = Workload.submitNewOrders(newOrderWareInInput, coordinator, 1000, 35000);
