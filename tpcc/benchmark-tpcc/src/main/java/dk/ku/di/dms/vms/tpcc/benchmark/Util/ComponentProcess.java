...
public class ComponentProcess
{
    ...
    {
        var vms = STR."\{vmsIdentifier}-tpcc";
    ...
    {
        var jarPath = STR."../\{vmsIdentifier}-tpcc/target/\{vmsIdentifier}-tpcc-1.0-SNAPSHOT-jar-with-dependencies.jar";
        var processBuilder = CreateProcessBuilder(jarPath, args);

        File workingDir = new File(STR."../\{vmsIdentifier}-tpcc");
